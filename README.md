...
- Download it in realeases, then run exe file to install. It will extract files in current directory and create desktop shortcut. You need to follow these instructions in first time setup, after done you can simply connect to directly your phone over wifi without any confirmation. 
